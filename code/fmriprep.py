...
OUTPUT_PATH = os.path.join(PROJECT_PATH, "data/derivatives/fmriprep")
WORK_PATH = os.path.join(PROJECT_PATH, "scratch/fmriprep")
FREESURFER_LICENSE = "/imaging/correia/da05/sandbox/camcan/freesurfer_license.txt"
